<template>
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <img v-bind:src="productDetails.image" v-bind:alt="productDetails.name" class="card-img-top">
            </div>
            <div class="col-sm-8">
                    ...
                    <div class="col-sm-12">
                        <form>
                            <div class="form-group row">
                                <label for="policyFrom" class="col-sm-3 col-form-label">Policy from </label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label for="policyTo" class="col-sm-3 col-form-label">Policy to </label>
                                <div class="col-sm-9">
        ...
        <div class="row">
            <div class="col-sm-12 margin-top-10">
                <div class="d-flex flex-row-reverse" v-if="'EDIT' === mode">
                    <div class="p-2">
                        <button type="submit" class="btn btn-primary" v-on:click.stop.prevent="calculatePrice">
                            Calculate price
                        </button>
                    </div>
                    <div class="p-2">
                ...
                <div class="d-flex flex-row-reverse" v-if="'VIEW' === mode">
                    <div class="p-2">
                        <button type="submit" class="btn btn-primary" v-on:click.stop.prevent="createOffer">
                            Buy
                        </button>
                    </div>
                    <div class="p-2">
                        <a class="btn btn-secondary" href="#" v-on:click.stop.prevent="backToEdit" role="button">
                            Change parameters
                        </a>
                    </div>
                    <div class="p-2">

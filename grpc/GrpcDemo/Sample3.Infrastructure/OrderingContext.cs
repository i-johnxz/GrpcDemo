...
using Sample3.Infrastructure.EntityConfigurations;

namespace Sample3.Infrastructure
{
    ...
    public class OrderingContextDesignFactory : IDesignTimeDbContextFactory<OrderingContext>
    {
        public OrderingContext CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<OrderingContext>()
                .UseSqlServer(
                    "Server=(localdb)\\projects;Database=Microsoft.eShopOnContainers.Services.OrderingDb;Integrated Security=true;");
